...
import NeutralColorPalette from './NeutralColorPalette';
import OpacityColorPalette from './OpacityColorPalette';
import Preview from './Preview';
import SimilarColorPalette from './SimilarColorPalette';
